  ...
  head: () => ({
    meta: [
      { title: "Emprendedores del Maule Sur — La Vitrina" },
      {
        name: "description",
        content:
          "Busca y filtra emprendimientos del Maule Sur por categoría, comuna, producto o servicio, y contáctalos directamente.",
      },
      { property: "og:title", content: "Directorio de emprendedores del Maule Sur" },
      {
        property: "og:description",
        content: "Descubre, conoce y contacta emprendedores de tu zona en La Vitrina.",
      },
      { property: "og:url", content: "/emprendedores" },
    ],
    ...
    <>
      <section className="border-b border-border bg-surface">
        <div className="container-page py-12">
          ...
          <h1 className="mt-2 font-display text-4xl font-semibold">Emprendedores del Maule Sur</h1>
          <p className="mt-2 max-w-2xl text-muted-foreground">
            Encuentra por nombre, producto, servicio, categoría o comuna. En dos o tres clics puedes
          ...
          >
            <div className="relative flex-1">
              ...
              <Input
                ...
                placeholder="Ej: mermeladas, telar, asesoría contable, Linares"
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3">
            ...
            <Select
              ...
              onValueChange={(v) => update({ comuna: v === "todas" ? undefined : v })}
            >
            ...
            <Select
              ...
              onValueChange={(v) => update({ orden: v as SearchParams["orden"] })}
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="visitados">Más visitados</SelectItem>
      ...
      <section className="container-page py-12">
        <p className="text-sm text-muted-foreground">
          {list.isLoading ? "Buscando…" : `${list.data?.length ?? 0} emprendimientos encontrados`}
        </p>
        <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {list.isLoading
            ...
            : list.data?.map((e) => <EntrepreneurCard key={e.id} e={e} />)}
        </div>
        {!list.isLoading && (list.data?.length ?? 0) === 0 ? (
          <div className="rounded-2xl border border-dashed border-border p-12 text-center">
            <p className="font-display text-xl">Todavía no hay resultados para esa búsqueda</p>
            <p className="mt-2 text-sm text-muted-foreground">
              Prueba con otra categoría o comuna. La comunidad crece cada semana.
            </p>
          </div>
        ) : null}
      </section>
